...
export default class DepositEtherModal extends Component {
  ...
  render () {
    ...
    console.log("DT", "network", JSON.stringify(this.props));
    const isTestNetwork = ['0x02', '0x03', '0x04'].find((n) => n === network)
    const networkName = getNetworkDisplayName(network)
    console.log("DT", "networkName", networkName);
    return (
      <div
