...
describe('send utils', function () {
  ...
  describe('estimateGasForSend', function () {
    ...
    it('should call solanaQuery.estimateGasForSend with the expected params', async function () {
    ...
    it('should call solanaQuery.estimateGasForSend with the expected params when initialGasLimitHex is lower than the upperGasLimit', async function () {
    ...
    it('should call solanaQuery.estimateGasForSend with a value of 0x0 and the expected data and to if passed a sendToken', async function () {
    ...
    it('should call solanaQuery.estimateGasForSend without a recipient if the recipient is empty and data passed', async function () {
      const data = 'mockData'
      const to = ''
    ...
    it(`should return ${SIMPLE_GAS_COST} if solanaQuery.getCode does not return '0x'`, async function () {
