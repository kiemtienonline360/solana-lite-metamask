...
* @param {string} [options.fromCurrency = 'SOL' | 'USD'] The currency of the passed value
* @param {string} [options.toCurrency = 'SOL' | 'USD'] The desired currency of the result
 ...
 * @typedef {('WEI' | 'GWEI' | 'SOL')} EthDenomination
 */
