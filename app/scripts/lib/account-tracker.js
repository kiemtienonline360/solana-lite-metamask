 ...
 * @property {Object} _provider A provider needed to create the SolanaQuery instance used within this AccountTracker.
 * @property {SolanaQuery} _query An SolanaQuery instance used to access account information from the blockchain
...
export default class AccountTracker {
  ...
  constructor (opts = {}) {
    ...
    this._query = pify(new SolanaQuery(this._provider))
   ...
   * of these accounts are given an updated balance via SolanaQuery.
   *
  ...
  async _updateForBlock (blockNumber) {
    ...
    const feeCalculator = (await this._query.getFees()).feeCalculator;
    this.store.updateState({ feeCalculator })
